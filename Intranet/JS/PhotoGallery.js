...
function getPhotoGallery(){
    ...
    var galleryurl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/getbytitle('"+PhotoGalleryListName+"')/Items?$select=File&$expand=File&$top=10&$orderBy=Modified desc";
